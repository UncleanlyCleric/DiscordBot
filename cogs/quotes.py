...
class QuotesCog(BaseCog):
    ...
    async def on_message(
        ...
        # -------------------------
        # !addmovies Some quote
        # !addgames Some quote
        # !addwhatever Some quote
        # -------------------------
        ...
        if content.startswith("!add"):
            ...
            if split_index <= 0:
                await message.channel.send(
                    "❌ Usage: `!add<category> <quote>`\n"
                    "Example: `!addmovies May the Force be with you.`"
                )
                return
        ...
        if content.startswith("!") and len(content) > 1:
            ...
            category = content[1:].split()[0].lower()
